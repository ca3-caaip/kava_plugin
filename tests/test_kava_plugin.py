...
class TestKavaPlugin(unittest.TestCase):
    ...
    def get_token_table_mock(cls):
        def mock_get_symbol(platform: str, token_original_id: str) -> Optional[str]:
            if platform == "kava" and token_original_id is None:
                return "kava"
            elif platform == "kava" and token_original_id == "hard":
                return "hard"
            elif platform == "kava" and token_original_id == "swp":
                return "swp"
            elif platform == "kava" and token_original_id == "busd":
                return "busd"
            elif platform == "kava" and token_original_id == "usdx":
                return "usdx"
            else:
                return None
    ...
    def test_transaction_fee(self):
        ...
        assert caaj_transaction_fee.service == "kava"
        assert (
    ...
    def test_delegate(self):
        ...
        assert caaj_deposit.application == "kava"
        assert caaj_deposit.service == "delegate"
        assert (
        ...
        assert caaj_reward.application == "kava"
        assert caaj_reward.service == "kava staking reward"
        assert (
    ...
    def test_begin_unbonding(self):
        ...
        assert caaj_withdraw.application == "kava"
        assert caaj_withdraw.service == "begin unbonding"
        assert (
    ...
    def test_create_cdp(self):
        ...
        assert caaj_deposit.platform == "kava"
        assert caaj_deposit.application == "kava"
        assert caaj_deposit.service == "cdp deposit"
        assert (
            caaj_deposit.transaction_id
        ...
        assert caaj_borrow.application == "kava"
        assert caaj_borrow.service == "cdp borrow"
        assert (
    ...
    def test_draw_cdp(self):
        ...
        assert caaj_borrow.platform == "kava"
        assert caaj_borrow.application == "kava"
        assert caaj_borrow.service == "cdp draw"
        assert (
            caaj_borrow.transaction_id
    ...
    def test_repay_cdp(self):
        ...
        assert caaj_repay.application == "kava"
        assert caaj_repay.service == "cdp repay"
        assert (
        ...
        assert caaj_withdraw.platform == "kava"
        assert caaj_withdraw.application == "kava"
        assert caaj_withdraw.service == "cdp withdraw"
        assert (
            caaj_withdraw.transaction_id
            == "158660081326903E34AD7B4CD1D95C600A743B63392F88667A388AB048E557FE"
        )
    ...
    def test_claim_usdx_minting_reward(self):
        ...
        assert caaj_reward.platform == "kava"
        assert caaj_reward.application == "kava"
        assert caaj_reward.service == "cdp claim reward"
        assert (
            caaj_reward.transaction_id
    ...
    def test_hard_deposit(self):
        ...
        assert caaj_deposit.platform == "kava"
        assert caaj_deposit.application == "kava"
        assert caaj_deposit.service == "hard deposit"
        assert (
            caaj_deposit.transaction_id
    ...
    def test_hard_withdraw(self):
        ...
        assert caaj_withdraw.platform == "kava"
        assert caaj_withdraw.application == "kava"
        assert caaj_withdraw.service == "hard withdraw"
        assert (
            caaj_withdraw.transaction_id
    ...
    def test_hard_borrow(self):
        ...
        assert caaj_borrow.platform == "kava"
        assert caaj_borrow.application == "kava"
        assert caaj_borrow.service == "hard borrow"
        assert (
            caaj_borrow.transaction_id
    ...
    def test_hard_repay(self):
        ...
        assert caaj_repay.platform == "kava"
        assert caaj_repay.application == "kava"
        assert caaj_repay.service == "hard repay"
        assert (
            caaj_repay.transaction_id
    ...
    def test_claim_hard_reward(self):
        ...
        assert caaj_reward.platform == "kava"
        assert caaj_reward.application == "kava"
        assert caaj_reward.service == "claim hard reward"
        assert (
            caaj_reward.transaction_id
    ...
    def test_swap_exact_for_tokens(self):
        ...
        assert caaj_swap_input.application == "kava"
        assert caaj_swap_input.service == "swap exact for tokens"
        assert (
        ...
        assert caaj_swap_output.application == "kava"
        assert caaj_swap_output.service == "swap exact for tokens"
        assert (
        ...
        assert caaj_swap_fee.application == "kava"
        assert caaj_swap_fee.service == "swap exact for tokens"
        assert (
    ...
    def test_swap_deposit(self):
        ...
        assert caaj_get_bonds.application == "kava"
        assert caaj_get_bonds.service == "swap deposit"
        assert (
        ...
        assert caaj_deposit.platform == "kava"
        assert caaj_deposit.application == "kava"
        assert caaj_deposit.service == "swap deposit"
        assert (
            caaj_deposit.transaction_id
            == "425BE10B2E9A6358CE30251C51FE910E3A4CA45F2928F3AC26F0A5C1C57576C8"
        )
    ...
    def test_swap_withdraw(self):
        ...
        assert caaj_get_bonds.platform == "kava"
        assert caaj_get_bonds.application == "kava"
        assert caaj_get_bonds.service == "swap withdraw"
        assert (
            caaj_get_bonds.transaction_id
        ...
        assert caaj_withdraw.platform == "kava"
        assert caaj_withdraw.application == "kava"
        assert caaj_withdraw.service == "swap withdraw"
        assert (
            caaj_withdraw.transaction_id
            == "AF18E27F1426740A1CA0704C13BC65C1B8AF21A739B570C7B6EC1EA8380453DD"
        )
    ...
    def test_claim_swap_reward(self):
        ...
        assert caaj_reward.platform == "kava"
        assert caaj_reward.application == "kava"
        assert caaj_reward.service == "claim swap reward"
        assert (
            caaj_reward.transaction_id
    ...
    def test_send(self):
        ...
        assert caaj_send.application == "kava"
        assert caaj_send.service == "send"
        assert (
    ...
    def test_create_atomic_swap(self):
        ...
        assert caaj_create_atomic_swap.application == "kava"
        assert caaj_create_atomic_swap.service == "create atomic swap"
        assert (
