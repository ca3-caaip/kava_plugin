...
class TestKavaPlugin(unittest.TestCase):
    ...
    def test_delegate(self):
        ...
        assert caaj_deposit.token_original_id is "kava"
        ...
        assert caaj_reward.token_original_id is "kava"
    ...
    def test_begin_unbonding(self):
        ...
        assert caaj_withdraw.token_original_id is "kava"
    ...
    def test_send(self):
        ...
        assert caaj_send.token_symbol == "kava"
        assert caaj_send.token_original_id is "kava"
